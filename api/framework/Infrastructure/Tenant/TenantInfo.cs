...
using NexKoala.Framework.Infrastructure.Tenant.Abstractions;

namespace NexKoala.Framework.Infrastructure.Tenant;
public sealed class TenantInfo : IFshTenantInfo
{
    public TenantInfo()
    {
    }
    ...
    public void SetValidity(in DateTime validTill) =>
        ValidUpto = ValidUpto < validTill
            ? validTill
            : throw new GenericException("Subscription cannot be backdated.");
