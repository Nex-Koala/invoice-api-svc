...
public class ClassificationListFilterSpec : EntitiesByPaginationFilterSpec<Classification, ClassificationResponse>
{
    public ClassificationListFilterSpec(int pageNumber, int pageSize, Guid userId)
